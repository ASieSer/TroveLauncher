...
(function () {
    ...
    const ICONS = {
        ...
        // Comprobar el inicio de sesión. Es el único icono que no es un SVG en
        // línea: el dibujo viene de web/img/log-in.png y se usa como máscara,
        // así que toma currentColor igual que los demás (ver .mask-icon).
    ...
    function buildActions(account, opts) {
        ...
        actions.appendChild(actionButton('login', 'Test login without launching', '',
